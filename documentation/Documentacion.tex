...
\begin{figure}[h]
	...
	\subcaption{Informe semanal}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{informeMensual}
	\subcaption{Informe mensual}
\end{figure}
...
A diferencia de las Activities, los \textit{Fragments} nos permiten poner contenido si necesidad de que ocupen toda la pantalla de móvil,
