...
\item \textbf{Doing}: Una vez establecidos los puntos a implementar en la app, cada uno elige una tarea y lo arrastra a este tablero, si la tarea es simple la asignamos a alguien directamente y al terminar se notificaba automáticamente al resto de los compañeros por email. 

Si la tarea es mas complicada se crean sub-tareas dentro de la tarea y se asignan a un miembro.
